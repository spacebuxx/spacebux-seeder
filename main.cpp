...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "spacebux-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.spacebucks.com",""};
static const string testnet_seeds[] = {"dnsseed.spacebucks.com",""};
